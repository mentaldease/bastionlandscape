...
float4x4 gWorldITXf : WORLDINVTRANSPOSE < string UIWidget="None"; >;
// transform object vertices to view space and project them in perspective:
float4x4 gWvpXf : WORLDVIEWPROJ < string UIWidget="None"; >;
// provide tranform from "view" or "eye" coords back to world-space:
float4x4 gViewIXf : VIEWINV < string UIWidget="None"; >;

float gTimer : TIME < string UIWidget = "None"; >;

//////////////// TEXTURES ///////////////////

texture NormalTexture : NORMALTEX <
...
texture gEnvTexture : ENVIRONMENTTEX <
